...
while systemctl show --property SubState --value testservice-57a.service | grep -q running
do
    sleep 0.1
done
...
while systemctl show --property SubState --value testservice-57b.service | grep -q running
do
    sleep 0.1
done
