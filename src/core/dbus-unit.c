...
const sd_bus_vtable bus_unit_vtable[] = {
        ...
        SD_BUS_PROPERTY("ImplicitDependencies", "b", bus_property_get_bool, offsetof(Unit, implicit_dependencies), SD_BUS_VTABLE_PROPERTY_CONST),
...
static int bus_unit_set_transient_property(
        ...
        if (streq(name, "ImplicitDependencies"))
                return bus_set_transient_bool(u, name, &u->implicit_dependencies, message, flags, error);
