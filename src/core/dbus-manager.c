...
const sd_bus_vtable bus_manager_vtable[] = {
        ...
        SD_BUS_METHOD("EnableUnitFilesWithFlags", "ast", "ba(sss)", method_enable_unit_files_with_flags, SD_BUS_VTABLE_UNPRIVILEGED),
        SD_BUS_METHOD("DisableUnitFilesWithFlags", "ast", "a(sss)", method_disable_unit_files_with_flags, SD_BUS_VTABLE_UNPRIVILEGED),
