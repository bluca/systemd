...
extern DLSYM_PROTOTYPE(getexeccon_raw);
extern DLSYM_PROTOTYPE(getfilecon_raw);
extern DLSYM_PROTOTYPE(getfscreatecon_raw);
extern DLSYM_PROTOTYPE(getkeycreatecon_raw);
extern DLSYM_PROTOTYPE(getpeercon_raw);
extern DLSYM_PROTOTYPE(getpidcon_raw);
extern DLSYM_PROTOTYPE(getprevcon_raw);
extern DLSYM_PROTOTYPE(getsockcreatecon_raw);
