...
int portable_attach(sd_bus *bus, const char *name_or_path, char **matches, const char *profile, const char *root_image, PortableFlags flags, PortableChange **changes, size_t *n_changes, sd_bus_error *error);
