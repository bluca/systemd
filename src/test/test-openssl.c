...
TEST(rsa_pkey_n_e) {
        ...
        _cleanup_(sym_EVP_PKEY_CTX_freep) EVP_PKEY_CTX *ctx = EVP_PKEY_CTX_new((EVP_PKEY*) pkey, NULL);
        assert_se(ctx);
...
TEST(ecc_ecdh) {
        _cleanup_(sym_EVP_PKEY_freep) EVP_PKEY *pkeyA = NULL, *pkeyB = NULL, *pkeyC = NULL;
