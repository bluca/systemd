...
static void test_condition_test_psi(void) {
        Condition *condition;
        CGroupMask mask;
        int r;
        ...
        condition = condition_new(CONDITION_CPU_PRESSURE, "1%", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_CPU_PRESSURE, "1%/10sec", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_CPU_PRESSURE, "100% / 1min", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_IO_PRESSURE, "50% / 1min", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);
        ...
        condition = condition_new(CONDITION_CPU_PRESSURE, "-.slice:100% / 1min", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_MEMORY_PRESSURE, "-.slice:0%/5min", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_MEMORY_PRESSURE, "-.slice:100%", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);

        condition = condition_new(CONDITION_IO_PRESSURE, "-.slice:0%", false, false);
        assert_se(condition);
        assert_se(condition_test(condition, environ) >= 0);
        condition_free(condition);
}
